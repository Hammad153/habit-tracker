...
const HABIT_BREAKDOWN_DATA = [
  { id: 1, title: "Read Quran", category: "Consistency", percentage: 80, icon: "book", iconBg: "rgba(56, 189, 248, 0.2)", iconColor: "#38BDF8" },
  { id: 2, title: "Morning Jog", category: "Consistency", percentage: 65, icon: "walk", iconBg: "rgba(168, 85, 247, 0.2)", iconColor: "#A855F7" },
  { id: 3, title: "Drink Water", category: "Consistency", percentage: 100, icon: "water", iconBg: "rgba(16, 185, 129, 0.2)", iconColor: "#10B981" },
];
        ...
        <ApHeader
            ...
            right={
                <Pressable onPress={() => router.push("/timeline")}>
                    <Ionicons name="calendar" size={24} color={ApTheme.Color.primary} />
                </Pressable>
            }
        />
